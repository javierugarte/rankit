    ...
    <div className="max-w-lg mx-auto px-4 pt-12 pb-24">
      ...
      <div className="flex flex-col items-center mb-10">
        <button
          ...
          className="relative w-20 h-20 rounded-full overflow-hidden mb-4 ring-2 ring-[#e05252] shadow-[0_0_14px_rgba(224,82,82,0.35)] transition-transform active:scale-95 active:transition-none"
        ...
        <button
          onClick={() => setShowEditModal(true)}
          className="mt-2 px-3 py-1 rounded-full text-xs font-medium border border-[#e05252]/40 text-[#e05252] hover:bg-[#e05252]/10 transition-colors active:scale-95 active:transition-none"
        >
          {t("editProfile")}
        </button>
        ...
        {stats.map(({ value, label }) => (
          ...
          >
            <p
              ...
              style={{ color: "#e05252", fontFamily: "Georgia, serif" }}
            >
              {value}
            </p>
